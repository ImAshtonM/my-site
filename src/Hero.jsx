export default function Hero(props) {
    return (
        <div id="hero" className="w-full my-2 p-2 md:min-h-[40dvh] flex justify-center items-center bg-[url(src/assets/hero4.jpg)] bg-[var(--mask-color)] bg-fixed bg-contain bg-bottom bg-blend-multiply">
            <div className="w-full h-full flex flex-col md:flex-row justify-center items-center gap-4 relative">
                <div className="md:basis-1/2 basis-full flex flex-col justify-items-center md:justify-items-start md:text-left gap-4">
                    <h1 className="text-4xl font-bold capitalize text-[var(--brand-color)]">{props.pageTitle}</h1>
