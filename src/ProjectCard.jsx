...
export default function ProjectCard(props) {
    ...
    return (
        <div className="project group glassCard relative w-1/4 min-w-[200px] max-w-3xs flex flex-col justify-evenly items-center p-3 bg-[var(--surface-color)] rounded-lg border-[var(--border-color)] shadow-md shadow-[var(--surface-shadow-color)] hover:shadow-lg hover:shadow-[var(--surface-shadow-hovered-color)]">
